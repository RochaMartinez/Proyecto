...
<div class="options__menu">	
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr class="campos">
									...
									<td>
										<a href="editar.php?id=<?php echo $data['idMateria']; ?>" class="btn btn-success"><i class='fas fa-edit'></i></a>

										<form action="eliminar.php?id=<?php echo $data['idMateria']; ?>" method="post" class="confirmar d-inline">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="agregar.php" class="btn btn-add"><i class='fas fa-audio-description'></i></a>
    </div>
    </main>
